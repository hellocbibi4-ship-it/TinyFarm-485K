...
| bootVersion             | spring boot version                      | 4.0.2                        |
...
|                                            | actual data store.                                           |                       |
|                                            |                                                              |                       |
| camel                                      | Apache Camel is an open source integration framework that    | >=3.5.0 and <4.0.0    |
...
|                                            | commodity servers.                                           |                       |
|                                            |                                                              |                       |
| cloud-bus                                  | Links nodes of a distributed system with a lightweight       | >=3.5.0 and <4.1.0-M1 |
|                                            | message broker which can used to broadcast state changes or  |                       |
|                                            | other management instructions (requires a binder, e.g.       |                       |
|                                            | Apache Kafka or RabbitMQ).                                   |                       |
|                                            |                                                              |                       |
| cloud-config-client                        | Client that connects to a Spring Cloud Config Server to      | >=3.5.0 and <4.1.0-M1 |
|                                            | fetch the application's configuration.                       |                       |
|                                            |                                                              |                       |
| cloud-config-server                        | Central management for configuration via Git, SVN, or        | >=3.5.0 and <4.1.0-M1 |
|                                            | HashiCorp Vault.                                             |                       |
|                                            |                                                              |                       |
| cloud-contract-stub-runner                 | Stub Runner for HTTP/Messaging based communication. Allows   | >=3.5.0 and <4.1.0-M1 |
|                                            | creating WireMock stubs from RestDocs tests.                 |                       |
|                                            |                                                              |                       |
| cloud-contract-verifier                    | Moves TDD to the level of software architecture by enabling  | >=3.5.0 and <4.1.0-M1 |
|                                            | Consumer Driven Contract (CDC) development.                  |                       |
|                                            |                                                              |                       |
| cloud-eureka                               | A REST based service for locating services for the purpose   | >=3.5.0 and <4.1.0-M1 |
|                                            | of load balancing and failover of middle-tier servers.       |                       |
|                                            |                                                              |                       |
| cloud-eureka-server                        | spring-cloud-netflix Eureka Server.                          | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| cloud-feign                                | Declarative REST Client. OpenFeign creates a dynamic         | >=3.5.0 and <4.1.0-M1 |
|                                            | implementation of an interface decorated with JAX-RS or      |                       |
|                                            | Spring MVC annotations.                                      |                       |
|                                            |                                                              |                       |
| cloud-function                             | Promotes the implementation of business logic via functions  | >=3.5.0 and <4.1.0-M1 |
|                                            | and supports a uniform programming model across serverless   |                       |
|                                            | providers, as well as the ability to run standalone (locally |                       |
|                                            | or in a PaaS).                                               |                       |
|                                            |                                                              |                       |
| cloud-gateway                              | Provides a simple, yet effective way to route to APIs in     | >=3.5.0 and <4.1.0-M1 |
|                                            | Servlet-based applications. Provides cross-cutting concerns  |                       |
|                                            | to those APIs such as security, monitoring/metrics, and      |                       |
|                                            | resiliency.                                                  |                       |
|                                            |                                                              |                       |
| cloud-gateway-reactive                     | Provides a simple, yet effective way to route to APIs in     | >=3.5.0 and <4.1.0-M1 |
|                                            | reactive applications. Provides cross-cutting concerns to    |                       |
|                                            | those APIs such as security, monitoring/metrics, and         |                       |
|                                            | resiliency.                                                  |                       |
|                                            |                                                              |                       |
| cloud-gcp                                  | Contains auto-configuration support for every Google Cloud   | >=3.5.0 and <4.0.0    |
|                                            | integration. Most of the auto-configuration code is only     |                       |
|                                            | enabled if other dependencies are added to the classpath.    |                       |
|                                            |                                                              |                       |
| cloud-gcp-pubsub                           | Adds the Google Cloud Support entry and all the required     | >=3.5.0 and <4.0.0    |
|                                            | dependencies so that the Google Cloud Pub/Sub integration    |                       |
|                                            | work out of the box.                                         |                       |
|                                            |                                                              |                       |
| cloud-gcp-storage                          | Adds the Google Cloud Support entry and all the required     | >=3.5.0 and <4.0.0    |
|                                            | dependencies so that the Google Cloud Storage integration    |                       |
|                                            | work out of the box.                                         |                       |
|                                            |                                                              |                       |
| cloud-loadbalancer                         | Client-side load-balancing with Spring Cloud LoadBalancer.   | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| cloud-resilience4j                         | Spring Cloud Circuit breaker with Resilience4j as the        | >=3.5.0 and <4.1.0-M1 |
|                                            | underlying implementation.                                   |                       |
|                                            |                                                              |                       |
| cloud-starter                              | Non-specific Spring Cloud features, unrelated to external    | >=3.5.0 and <4.1.0-M1 |
|                                            | libraries or integrations (e.g. Bootstrap context and        |                       |
|                                            | @RefreshScope).                                              |                       |
|                                            |                                                              |                       |
| cloud-starter-consul-config                | Enable and configure the common patterns inside your         | >=3.5.0 and <4.1.0-M1 |
...
|                                            |                                                              |                       |
| cloud-starter-consul-discovery             | Service discovery with Hashicorp Consul.                     | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| cloud-starter-vault-config                 | Provides client-side support for externalized configuration  | >=3.5.0 and <4.1.0-M1 |
...
|                                            |                                                              |                       |
| cloud-starter-zookeeper-config             | Enable and configure common patterns inside your application | >=3.5.0 and <4.1.0-M1 |
|                                            | and build large distributed systems with Apache Zookeeper    |                       |
|                                            | based components. The provided patterns include Service      |                       |
|                                            | Discovery and Configuration.                                 |                       |
|                                            |                                                              |                       |
| cloud-starter-zookeeper-discovery          | Service discovery with Apache Zookeeper.                     | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| cloud-stream                               | Framework for building highly scalable event-driven          | >=3.5.0 and <4.1.0-M1 |
...
|                                            |                                                              |                       |
| cloud-task                                 | Allows a user to develop and run short lived microservices   | >=3.5.0 and <4.1.0-M1 |
...
|                                            |                                                              |                       |
| codecentric-spring-boot-admin-client       | Required for your application to register with a             | >=3.5.0 and <4.0.0    |
|                                            | Codecentric's Spring Boot Admin Server instance.             |                       |
|                                            |                                                              |                       |
| codecentric-spring-boot-admin-server       | A community project to manage and monitor your Spring Boot   | >=3.5.0 and <4.0.0    |
...
|                                            |                                                              |                       |
| mcp-security                               | Provides security for Spring AI's MCP server and client, and | >=3.5.0 and <4.1.0-M1 |
...
|                                            |                                                              |                       |
| scs-config-client                          | Config client on VMware Tanzu Application Service.           | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| scs-service-registry                       | Eureka service discovery client on VMware Tanzu Application  | >=3.5.0 and <4.1.0-M1 |
|                                            | Service.                                                     |                       |
|                                            |                                                              |                       |
...
|                                            | session information.                                         |                       |
|                                            |                                                              |                       |
| solace                                     | Connect to a Solace PubSub+ Advanced Event Broker to         | >=3.5.0 and <4.0.0    |
|                                            | publish, subscribe, request/reply and store/replay messages  |                       |
|                                            |                                                              |                       |
| spring-ai-anthropic                        | Spring AI support for Anthropic Claude AI models.            | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| spring-ai-azure-openai                     | Spring AI support for Azure’s OpenAI offering, powered by    | >=3.5.0 and <4.1.0-M1 |
|                                            | ChatGPT. It extends beyond traditional OpenAI capabilities,  |                       |
|                                            | delivering AI-driven text generation with enhanced           |                       |
|                                            | functionality.                                               |                       |
|                                            |                                                              |                       |
| spring-ai-bedrock                          | Spring AI support for Amazon Bedrock Cohere and Titan        | >=3.5.0 and <4.1.0-M1 |
|                                            | Embedding Models.                                            |                       |
|                                            |                                                              |                       |
| spring-ai-bedrock-converse                 | Spring AI support for Amazon Bedrock Converse. It provides a | >=3.5.0 and <4.1.0-M1 |
...
|                                            |                                                              |                       |
| spring-ai-chat-memory-repository-cassandra | Spring AI support for Cassandra based chat memory.           | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| spring-ai-chat-memory-repository-cosmos-db | Spring AI support for Azure Cosmos DB based chat memory.     | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| spring-ai-chat-memory-repository-in-memory | Spring AI support for in-memory chat memory repository.      | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| spring-ai-chat-memory-repository-jdbc      | Spring AI support for JDBC based chat memory.                | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| spring-ai-chat-memory-repository-mongodb   | Spring AI support for MongoDB based chat memory.             | >=3.5.0 and <4.0.0    |
|                                            |                                                              |                       |
| spring-ai-chat-memory-repository-neo4j     | Spring AI support for Neo4j based chat memory.               | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| spring-ai-deepseek                         | Spring AI support for DeepSeek AI models.                    | >=3.5.0 and <4.0.0    |
|                                            |                                                              |                       |
| spring-ai-elevenlabs                       | Spring AI support for ElevenLabs text-to-speech models.      | >=3.5.0 and <4.0.0    |
|                                            |                                                              |                       |
| spring-ai-google-genai                     | Spring AI support for Google GenAI (Gemini) models.          | >=3.5.0 and <4.0.0    |
|                                            |                                                              |                       |
| spring-ai-google-genai-embedding           | Spring AI support for Google GenAI embedding models.         | >=3.5.0 and <4.0.0    |
|                                            |                                                              |                       |
| spring-ai-huggingface                      | Spring AI support for HuggingFace AI models.                 | >=3.5.0 and <4.0.0    |
|                                            |                                                              |                       |
| spring-ai-jsoup-document-reader            | Spring AI HTML document reader using JSoup. It parses HTML   | >=3.5.0 and <4.1.0-M1 |
|                                            | documents and converts them into a list of Spring AI         |                       |
|                                            | Document objects.                                            |                       |
|                                            |                                                              |                       |
| spring-ai-markdown-document-reader         | Spring AI Markdown document reader. It allows to load        | >=3.5.0 and <4.1.0-M1 |
|                                            | Markdown documents, converting them into a list of Spring AI |                       |
|                                            | Document objects.                                            |                       |
|                                            |                                                              |                       |
| spring-ai-mcp-client                       | Spring AI support for Model Context Protocol (MCP) clients.  | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| spring-ai-mcp-server                       | Spring AI support for Model Context Protocol (MCP) servers.  | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| spring-ai-minimax                          | Spring AI support for MiniMax AI models.                     | >=3.5.0 and <4.0.0    |
|                                            |                                                              |                       |
| spring-ai-mistral                          | Spring AI support for Mistral AI, the open and portable      | >=3.5.0 and <4.1.0-M1 |
...
|                                            | GenAI models.                                                |                       |
|                                            |                                                              |                       |
| spring-ai-ollama                           | Spring AI support for Ollama. It allows you to run various   | >=3.5.0 and <4.1.0-M1 |
|                                            | Large Language Models (LLMs) locally and generate text from  |                       |
|                                            | them.                                                        |                       |
|                                            |                                                              |                       |
| spring-ai-openai                           | Spring AI support for ChatGPT, the AI language model and     | >=3.5.0 and <4.1.0-M1 |
|                                            | DALL-E, the Image generation model from OpenAI.              |                       |
|                                            |                                                              |                       |
| spring-ai-openai-sdk                       | Spring AI support for OpenAI using the official OpenAI SDK.  | >=3.5.0 and <4.1.0-M1 |
|                                            | Alternative implementation with enhanced features and        |                       |
|                                            | compatibility.                                               |                       |
|                                            |                                                              |                       |
| spring-ai-pdf-document-reader              | Spring AI PDF document reader. It uses Apache PdfBox to      | >=3.5.0 and <4.1.0-M1 |
|                                            | extract text from PDF documents and converting them into a   |                       |
|                                            | list of Spring AI Document objects.                          |                       |
|                                            |                                                              |                       |
| spring-ai-postgresml                       | Spring AI support for the PostgresML text embeddings models. | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| spring-ai-stabilityai                      | Spring AI support for Stability AI's text to image           | >=3.5.0 and <4.1.0-M1 |
|                                            | generation model.                                            |                       |
|                                            |                                                              |                       |
| spring-ai-tika-document-reader             | Spring AI Tika document reader. It uses Apache Tika to       | >=3.5.0 and <4.1.0-M1 |
...
|                                            |                                                              |                       |
| spring-ai-transformers                     | Spring AI support for pre-trained transformer models,        | >=3.5.0 and <4.1.0-M1 |
|                                            | serialized into the Open Neural Network Exchange (ONNX)      |                       |
|                                            | format.                                                      |                       |
|                                            |                                                              |                       |
| spring-ai-vectordb-aws-opensearch          | Spring AI vector database support for AWS OpenSearch         | >=3.5.0 and <4.0.0    |
|                                            | Service.                                                     |                       |
|                                            |                                                              |                       |
| spring-ai-vectordb-azure                   | Spring AI vector database support for Azure AI Search. It is | >=3.5.0 and <4.1.0-M1 |
...
|                                            | and retrieval.                                               |                       |
|                                            |                                                              |                       |
| spring-ai-vectordb-azurecosmosdb           | Spring AI support for Azure Cosmos DB. Azure Cosmos DB is    | >=3.5.0 and <4.1.0-M1 |
|                                            | Microsoft’s globally distributed cloud-native database       |                       |
|                                            | service designed for mission-critical applications.          |                       |
|                                            |                                                              |                       |
| spring-ai-vectordb-bedrock-knowledgebase   | Spring AI vector database support for Amazon Bedrock         | >=4.0.0 and <4.1.0-M1 |
|                                            | Knowledge Base. It provides fully managed                    |                       |
|                                            | Retrieval-Augmented Generation (RAG) capabilities with       |                       |
|                                            | enterprise-grade security and privacy.                       |                       |
|                                            |                                                              |                       |
| spring-ai-vectordb-cassandra               | Spring AI vector database support for Apache Cassandra.      | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| spring-ai-vectordb-chroma                  | Spring AI vector database support for Chroma. It is an       | >=3.5.0 and <4.1.0-M1 |
...
|                                            | metadata filtering.                                          |                       |
|                                            |                                                              |                       |
| spring-ai-vectordb-couchbase               | Spring AI vector database support for Couchbase.             | >=3.5.0 and <4.0.0    |
|                                            |                                                              |                       |
| spring-ai-vectordb-elasticsearch           | Spring AI vector database support for Elasticsearch.         | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| spring-ai-vectordb-gemfire                 | Spring AI vector database support for GemFire.               | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| spring-ai-vectordb-mariadb                 | Spring AI support for MariaDB. MariaDB Vector Store support  | >=3.5.0 and <4.1.0-M1 |
...
|                                            | metrics.                                                     |                       |
|                                            |                                                              |                       |
| spring-ai-vectordb-milvus                  | Spring AI vector database support for Milvus. It is an       | >=3.5.0 and <4.1.0-M1 |
...
|                                            |                                                              |                       |
| spring-ai-vectordb-mongodb-atlas           | Spring AI vector database support for MongoDB Atlas. Is is a | >=3.5.0 and <4.1.0-M1 |
|                                            | fully managed cloud database service that provides an easy   |                       |
|                                            | way to deploy, operate, and scale a MongoDB database in the  |                       |
|                                            | cloud.                                                       |                       |
|                                            |                                                              |                       |
| spring-ai-vectordb-neo4j                   | Spring AI vector database support for Neo4j's Vector Search. | >=3.5.0 and <4.1.0-M1 |
|                                            | It allows users to query vector embeddings from large        |                       |
|                                            | datasets.                                                    |                       |
|                                            |                                                              |                       |
| spring-ai-vectordb-opensearch              | Spring AI vector database support for OpenSearch.            | >=3.5.0 and <4.0.0    |
|                                            |                                                              |                       |
| spring-ai-vectordb-oracle                  | Spring AI vector database support for Oracle. Enables        | >=3.5.0 and <4.1.0-M1 |
|                                            | storing, indexing and searching vector embeddings in Oracle  |                       |
|                                            | Database 23ai.                                               |                       |
|                                            |                                                              |                       |
| spring-ai-vectordb-pgvector                | Spring AI vector database support for PGvector. It is an     | >=3.5.0 and <4.1.0-M1 |
|                                            | open-source extension for PostgreSQL that enables storing    |                       |
|                                            | and searching over machine learning-generated embeddings.    |                       |
|                                            |                                                              |                       |
| spring-ai-vectordb-pinecone                | Spring AI vector database support for Pinecone. It is a      | >=3.5.0 and <4.1.0-M1 |
|                                            | popular cloud-based vector database and allows you to store  |                       |
|                                            | and search vectors efficiently.                              |                       |
|                                            |                                                              |                       |
| spring-ai-vectordb-qdrant                  | Spring AI vector database support for Qdrant. It is an       | >=3.5.0 and <4.1.0-M1 |
|                                            | open-source, high-performance vector search engine/database. |                       |
|                                            |                                                              |                       |
| spring-ai-vectordb-redis                   | Spring AI vector database support for Redis Search and       | >=3.5.0 and <4.1.0-M1 |
|                                            | Query. It extends the core features of Redis OSS and allows  |                       |
|                                            | you to use Redis as a vector database.                       |                       |
|                                            |                                                              |                       |
| spring-ai-vectordb-s3                      | Spring AI vector database support for AWS S3. Store and      | >=4.0.0 and <4.1.0-M1 |
|                                            | retrieve vector embeddings using Amazon S3 object storage    |                       |
|                                            | with efficient search capabilities.                          |                       |
|                                            |                                                              |                       |
| spring-ai-vectordb-typesense               | Spring AI vector database support for Typesense.             | >=3.5.0 and <4.1.0-M1 |
|                                            |                                                              |                       |
| spring-ai-vectordb-weaviate                | Spring AI vector database support for Weaviate, an           | >=3.5.0 and <4.1.0-M1 |
...
|                                            |                                                              |                       |
| spring-ai-vertexai-embeddings              | Spring AI support for Google Vertex text and multimodal      | >=3.5.0 and <4.1.0-M1 |
|                                            | embedding models.                                            |                       |
|                                            |                                                              |                       |
| spring-ai-vertexai-gemini                  | Spring AI support for Google Vertex Gemini chat. Doesn't     | >=3.5.0 and <4.1.0-M1 |
|                                            | support embeddings.                                          |                       |
|                                            |                                                              |                       |
| spring-ai-zhipuai                          | Spring AI support for ZhipuAI models.                        | >=3.5.0 and <4.0.0    |
|                                            |                                                              |                       |
| spring-grpc                                | Support for gRPC, a high performance, open source universal  | >=4.0.0 and <4.1.0-M1 |
|                                            | RPC framework.                                               |                       |
|                                            |                                                              |                       |
...
|                                            |                                                              |                       |
| timefold-solver                            | AI solver to optimize operations and scheduling.             | >=3.5.0 and <4.0.0    |
|                                            |                                                              |                       |
| unboundid-ldap                             | Provides a platform neutral way for running a LDAP server in |                       |
|                                            | unit tests.                                                  |                       |
|                                            |                                                              |                       |
| vaadin                                     | The full-stack web app platform for Spring. Build views      | >=3.5.0 and <4.1.0-M1 |
